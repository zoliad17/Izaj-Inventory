...
function NotificationsPage() {
  ...
  const notifications: NotificationItem[] = [
    ...
    },
    {
      ...
      message: "Purchase order created for product restock",
      time: "10 days ago",
      type: "product",
    },
    {
    ...
    // Additional notifications to ensure scrolling
    {
      id: 9,
      icon: Package,
      ...
      message: "Smart Home Devices category is now available",
      time: "2 weeks ago",
      type: "product",
    },
    {
      ...
      message: "Downtown Branch is now operational",
      time: "3 weeks ago",
      type: "transfer",
    },
    {
      ...
      message: "Review your branch's inventory performance",
      time: "1 month ago",
      type: "product",
    },
    {
      ...
      iconBgClass: "bg-red-100 dark:bg-red-900/30",
      iconColorClass: "text-red-600 dark:text-red-400",
      title: "Stocktake scheduled",
      message: "Annual stocktake is scheduled for next Friday",
      time: "1 month ago",
      type: "alert",
    },
    {
      ...
      message: "Your branch ranks #2 in sales this quarter",
      time: "1 month ago",
      type: "transfer",
    },
    {
      ...
      iconBgClass: "bg-blue-100 dark:bg-blue-900/30",
      iconColorClass: "text-blue-600 dark:text-blue-400",
      title: "Seasonal restocking",
      message: "Prepare for increased demand during holiday season",
      time: "2 months ago",
      type: "product",
    },
    {
      ...
      message: "Shipment from ABC Supplier delayed by 3 days",
      time: "2 months ago",
      type: "alert",
    },
    {
      ...
      message: "Inventory management training tomorrow at 2 PM",
      time: "2 months ago",
      type: "transfer",
    },
  ];
