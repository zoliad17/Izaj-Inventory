...
const AuditLogDetailView: React.FC<AuditLogDetailViewProps> = ({ log, onClose }) => {
    ...
    const renderJsonData = (data: any, title: string) => {
        ...
        return (
            <div className="space-y-2">
                <button
                    onClick={() => toggleSection(title.toLowerCase().replace(' ', '') as keyof typeof expandedSections)}
                ...
                >
                    ...
                    {expandedSections[title.toLowerCase().replace(' ', '') as keyof typeof expandedSections] ?
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-3">
                                    <div className={`px-3 py-1 rounded-full text-xs font-medium border ${getSeverityColor(log.severity_level || 'medium')}`}>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-gray-900">{log.user_name || 'Unknown'}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-500">Email</p>
                                    <p className="text-gray-900">{log.user_email || 'Unknown'}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-500">Role</p>
                                    <p className="text-gray-900">{log.role_name || 'Unknown'}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-500">Branch</p>
                                    <p className="text-gray-900">{log.branch_location || 'Unknown'}</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="mt-4 space-y-4">
                                    ...
                                    {log.user_agent && (
                                        <div>
                                            ...
                                            <p className="text-gray-900 text-sm break-all">{log.user_agent}</p>
                                        </div>
                                    )}
                                </div>
                            )}
